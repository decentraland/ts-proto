...
export namespace EchoMsg {
  export function encode(message: EchoMsg, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.body !== "") {
  ...
  export function decode(input: _m0.Reader | Uint8Array, length?: number): EchoMsg {
  ...
  export function fromPartial<I extends Exact<DeepPartial<EchoMsg>, I>>(object: I): EchoMsg {
    const message = createBaseEchoMsg();
